 ...
 */
class CpEtablissementFromRsForm extends BaseCpEtablissementForm {

    public function configure() {
        unset(
                $this['cp_etablissement_ville_id'],
                //$this['cp_etablissement_etablissement_nom'],
        ...
        //chanp rendu hidden puisque formulaire avec raison sociale connue
        $this->widgetSchema['cp_etablissement_etablissement_pere_id'] = new sfWidgetFormInputHidden();
        
        //champ pertmettant le passage de la raison sociale
        $this->widgetSchema['nomRs'] = new sfWidgetFormInputHidden();
        $this->validatorSchema['nomRs'] = new sfValidatorString(array('required' => true));
        ...
        //sléction des établissement parent (société
        /*
          ...
          'method' => 'getEtablissementRaisonSociale',
          'add_empty' => true,
          ));
         */
