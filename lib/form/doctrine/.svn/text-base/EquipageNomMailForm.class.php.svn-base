 ...
 */
//class EquipageNomMailForm extends BaseEquipageForm
class EquipageNomMailForm extends BaseFormDoctrine
{
    /*
   public function configure()
  {
    unset(
      $this['id_equipage'], $this['id_trajet'],
      $this['id_createur'], $this['id_site'],
      $this['cle'], $this['etat'],
      $this['date_creation'], $this['Trajet'],
      $this['_csrf_token']
    );
    ...
    $this->setValidators(array('_csrf_token'=> new sfValidatorPass()));

    $this->validatorSchema['mail_covoitureur'] = new sfValidatorEmail(array('max_length' => 255, 'required' => true));
