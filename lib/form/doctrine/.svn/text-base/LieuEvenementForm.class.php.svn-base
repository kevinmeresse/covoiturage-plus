 ...
 */
class LieuEvenementForm extends BaseLieuForm {

    public function configure() {
        unset(
                $this['id_lieu'], $this['id_site_site'], $this['id_pour_partenaire'], $this['bascule_insee'], $this['date_creation'], $this['date_evenement'], $this['date_modification'], $this['date_depublication']);
        ...
        $this->widgetSchema['id_lieu_type'] = new sfWidgetFormDoctrineChoice(array(
                    ...
                    'query' => Doctrine::getTable('LieuType')->getLieuTypeEvenementSite(),
                    'add_empty' => true,
                ));
