 ...
 */
class TrajetRechercheForm extends BaseTrajetForm {
    ...
    public function configure() {
        ...
        */
        ...
        if (!empty($filtre["horaire_id"]) ) {
           $this->setDefault('horaire_id',$filtre["horaire_id"] );
        }
        ...
        if (!empty($filtre["secteur_id"]) ) {
           $this->setDefault('secteur_id',$filtre["secteur_id"] );
        }
        ...
        if(isset ($filtre["id_type_trajet"])){
