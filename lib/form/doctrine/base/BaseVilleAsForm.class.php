...
/**
 * VilleAs form base class.
 *
 * @method VilleAs getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseVilleAsForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ville_as[%s]');
