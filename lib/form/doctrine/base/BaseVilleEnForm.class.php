...
/**
 * VilleEn form base class.
 *
 * @method VilleEn getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseVilleEnForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ville_en[%s]');
