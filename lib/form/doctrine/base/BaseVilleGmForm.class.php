...
/**
 * VilleGm form base class.
 *
 * @method VilleGm getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseVilleGmForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ville_gm[%s]');
