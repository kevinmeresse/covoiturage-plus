...
/**
 * VilleFi form base class.
 *
 * @method VilleFi getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseVilleFiForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ville_fi[%s]');
