...
/**
 * VilleUp form base class.
 *
 * @method VilleUp getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseVilleUpForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ville_up[%s]');
