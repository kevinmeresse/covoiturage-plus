...
/**
 * VilleSp form base class.
 *
 * @method VilleSp getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseVilleSpForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ville_sp[%s]');
