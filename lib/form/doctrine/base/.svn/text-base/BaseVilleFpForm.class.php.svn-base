...
/**
 * VilleFp form base class.
 *
 * @method VilleFp getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseVilleFpForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ville_fp[%s]');
