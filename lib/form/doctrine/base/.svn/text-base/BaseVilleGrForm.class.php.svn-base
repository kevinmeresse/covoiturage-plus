...
/**
 * VilleGr form base class.
 *
 * @method VilleGr getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseVilleGrForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ville_gr[%s]');
