...
/**
 * VilleFg form base class.
 *
 * @method VilleFg getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseVilleFgForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ville_fg[%s]');
