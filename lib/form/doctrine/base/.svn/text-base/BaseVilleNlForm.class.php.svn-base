...
/**
 * VilleNl form base class.
 *
 * @method VilleNl getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseVilleNlForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ville_nl[%s]');
