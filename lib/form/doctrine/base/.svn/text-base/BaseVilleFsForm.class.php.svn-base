...
/**
 * VilleFs form base class.
 *
 * @method VilleFs getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseVilleFsForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ville_fs[%s]');
