...
/**
 * VilleUk form base class.
 *
 * @method VilleUk getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseVilleUkForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ville_uk[%s]');
