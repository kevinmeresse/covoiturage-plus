...
/**
 * VilleIp form base class.
 *
 * @method VilleIp getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseVilleIpForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ville_ip[%s]');
