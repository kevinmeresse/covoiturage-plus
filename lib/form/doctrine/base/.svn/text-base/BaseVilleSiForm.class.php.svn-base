...
/**
 * VilleSi form base class.
 *
 * @method VilleSi getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseVilleSiForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ville_si[%s]');
