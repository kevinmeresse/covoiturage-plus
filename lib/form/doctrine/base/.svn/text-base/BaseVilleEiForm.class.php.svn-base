...
/**
 * VilleEi form base class.
 *
 * @method VilleEi getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseVilleEiForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ville_ei[%s]');
