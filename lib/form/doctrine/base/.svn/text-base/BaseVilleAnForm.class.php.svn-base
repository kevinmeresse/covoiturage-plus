...
/**
 * VilleAn form base class.
 *
 * @method VilleAn getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseVilleAnForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ville_an[%s]');
