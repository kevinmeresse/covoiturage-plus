...
/**
 * VilleAu form base class.
 *
 * @method VilleAu getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseVilleAuForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ville_au[%s]');
