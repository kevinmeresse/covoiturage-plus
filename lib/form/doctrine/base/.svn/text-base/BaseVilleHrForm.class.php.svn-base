...
/**
 * VilleHr form base class.
 *
 * @method VilleHr getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseVilleHrForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ville_hr[%s]');
