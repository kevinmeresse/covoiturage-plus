...
/**
 * VilleBe form base class.
 *
 * @method VilleBe getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseVilleBeForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ville_be[%s]');
