...
/**
 * VilleIt form base class.
 *
 * @method VilleIt getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseVilleItForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ville_it[%s]');
