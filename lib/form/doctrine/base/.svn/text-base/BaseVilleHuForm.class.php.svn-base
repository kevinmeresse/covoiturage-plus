...
/**
 * VilleHu form base class.
 *
 * @method VilleHu getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseVilleHuForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ville_hu[%s]');
