...
/**
 * VilleDa form base class.
 *
 * @method VilleDa getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseVilleDaForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ville_da[%s]');
