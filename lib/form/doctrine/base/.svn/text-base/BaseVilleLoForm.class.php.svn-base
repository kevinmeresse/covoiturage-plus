...
/**
 * VilleLo form base class.
 *
 * @method VilleLo getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseVilleLoForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ville_lo[%s]');
