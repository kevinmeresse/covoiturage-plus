...
/**
 * VilleSz form base class.
 *
 * @method VilleSz getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseVilleSzForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ville_sz[%s]');
