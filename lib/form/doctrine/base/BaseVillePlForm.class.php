...
/**
 * VillePl form base class.
 *
 * @method VillePl getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseVillePlForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ville_pl[%s]');
