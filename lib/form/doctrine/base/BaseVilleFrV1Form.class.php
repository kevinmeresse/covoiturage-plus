...
/**
 * VilleFrV1 form base class.
 *
 * @method VilleFrV1 getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseVilleFrV1Form extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'chef_lieu'       => new sfValidatorInteger(),
    ));

    $this->widgetSchema->setNameFormat('ville_fr_v1[%s]');
