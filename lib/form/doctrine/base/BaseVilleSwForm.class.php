...
/**
 * VilleSw form base class.
 *
 * @method VilleSw getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseVilleSwForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ville_sw[%s]');
