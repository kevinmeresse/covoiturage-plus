...
/**
 * VilleAv form base class.
 *
 * @method VilleAv getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseVilleAvForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ville_av[%s]');
