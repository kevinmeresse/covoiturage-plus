...
/**
 * VilleRb form base class.
 *
 * @method VilleRb getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseVilleRbForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ville_rb[%s]');
