...
/**
 * VilleBu form base class.
 *
 * @method VilleBu getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseVilleBuForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ville_bu[%s]');
