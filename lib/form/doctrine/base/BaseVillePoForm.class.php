...
/**
 * VillePo form base class.
 *
 * @method VillePo getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseVillePoForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ville_po[%s]');
