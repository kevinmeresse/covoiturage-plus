...
/**
 * VilleRo form base class.
 *
 * @method VilleRo getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseVilleRoForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ville_ro[%s]');
