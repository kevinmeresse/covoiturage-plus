...
Doctrine_Manager::getInstance()->bindComponent('sfGuardPermission', 'dbrmv3');
 ...
 * @method sfGuardPermission   setContenu()                Sets the current record's "Contenu" collection
 * @method sfGuardPermission   setContenuRubrique()        Sets the current record's "ContenuRubrique" collection
 * 
