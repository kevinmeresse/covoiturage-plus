...
Doctrine_Manager::getInstance()->bindComponent('VilleAn', 'dbrmv3');
 ...
 * @method VilleAn   setIdVille()    Sets the current record's "id_ville" value
 * @method VilleAn   setIdPays()     Sets the current record's "id_pays" value
 * @method VilleAn   setNomVille()   Sets the current record's "nom_ville" value
 * @method VilleAn   setNomVille2()  Sets the current record's "nom_ville2" value
 * @method VilleAn   setLatitude()   Sets the current record's "latitude" value
 * @method VilleAn   setLongitude()  Sets the current record's "longitude" value
 * @method VilleAn   setPaysMonde()  Sets the current record's "PaysMonde" value
 * 
 ...
 */
abstract class BaseVilleAn extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('ville_an');
