...
Doctrine_Manager::getInstance()->bindComponent('VilleEi', 'dbrmv3');
 ...
 * @method VilleEi   setIdVille()    Sets the current record's "id_ville" value
 * @method VilleEi   setIdPays()     Sets the current record's "id_pays" value
 * @method VilleEi   setNomVille()   Sets the current record's "nom_ville" value
 * @method VilleEi   setNomVille2()  Sets the current record's "nom_ville2" value
 * @method VilleEi   setLatitude()   Sets the current record's "latitude" value
 * @method VilleEi   setLongitude()  Sets the current record's "longitude" value
 * @method VilleEi   setPaysMonde()  Sets the current record's "PaysMonde" value
 * 
 ...
 */
abstract class BaseVilleEi extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('ville_ei');
