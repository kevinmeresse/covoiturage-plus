...
Doctrine_Manager::getInstance()->bindComponent('VilleIt', 'dbrmv3');
 ...
 * @method VilleIt   setIdVille()    Sets the current record's "id_ville" value
 * @method VilleIt   setIdPays()     Sets the current record's "id_pays" value
 * @method VilleIt   setNomVille()   Sets the current record's "nom_ville" value
 * @method VilleIt   setNomVille2()  Sets the current record's "nom_ville2" value
 * @method VilleIt   setLatitude()   Sets the current record's "latitude" value
 * @method VilleIt   setLongitude()  Sets the current record's "longitude" value
 * @method VilleIt   setPaysMonde()  Sets the current record's "PaysMonde" value
 * 
 ...
 */
abstract class BaseVilleIt extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('ville_it');
