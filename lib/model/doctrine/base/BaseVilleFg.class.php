...
Doctrine_Manager::getInstance()->bindComponent('VilleFg', 'dbrmv3');
 ...
 * @method VilleFg   setIdVille()    Sets the current record's "id_ville" value
 * @method VilleFg   setIdPays()     Sets the current record's "id_pays" value
 * @method VilleFg   setNomVille()   Sets the current record's "nom_ville" value
 * @method VilleFg   setNomVille2()  Sets the current record's "nom_ville2" value
 * @method VilleFg   setLatitude()   Sets the current record's "latitude" value
 * @method VilleFg   setLongitude()  Sets the current record's "longitude" value
 * @method VilleFg   setPaysMonde()  Sets the current record's "PaysMonde" value
 * 
 ...
 */
abstract class BaseVilleFg extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('ville_fg');
