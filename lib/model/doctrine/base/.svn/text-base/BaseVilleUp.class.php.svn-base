...
Doctrine_Manager::getInstance()->bindComponent('VilleUp', 'dbrmv3');
 ...
 * @method VilleUp   setIdVille()    Sets the current record's "id_ville" value
 * @method VilleUp   setIdPays()     Sets the current record's "id_pays" value
 * @method VilleUp   setNomVille()   Sets the current record's "nom_ville" value
 * @method VilleUp   setNomVille2()  Sets the current record's "nom_ville2" value
 * @method VilleUp   setLatitude()   Sets the current record's "latitude" value
 * @method VilleUp   setLongitude()  Sets the current record's "longitude" value
 * @method VilleUp   setPaysMonde()  Sets the current record's "PaysMonde" value
 * 
 ...
 */
abstract class BaseVilleUp extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('ville_up');
