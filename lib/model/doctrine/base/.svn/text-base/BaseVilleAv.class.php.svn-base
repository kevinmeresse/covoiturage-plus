...
Doctrine_Manager::getInstance()->bindComponent('VilleAv', 'dbrmv3');
 ...
 * @method VilleAv   setIdVille()    Sets the current record's "id_ville" value
 * @method VilleAv   setIdPays()     Sets the current record's "id_pays" value
 * @method VilleAv   setNomVille()   Sets the current record's "nom_ville" value
 * @method VilleAv   setNomVille2()  Sets the current record's "nom_ville2" value
 * @method VilleAv   setLatitude()   Sets the current record's "latitude" value
 * @method VilleAv   setLongitude()  Sets the current record's "longitude" value
 * @method VilleAv   setPaysMonde()  Sets the current record's "PaysMonde" value
 * 
 ...
 */
abstract class BaseVilleAv extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('ville_av');
