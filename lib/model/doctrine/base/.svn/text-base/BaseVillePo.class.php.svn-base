...
Doctrine_Manager::getInstance()->bindComponent('VillePo', 'dbrmv3');
 ...
 * @method VillePo   setIdVille()    Sets the current record's "id_ville" value
 * @method VillePo   setIdPays()     Sets the current record's "id_pays" value
 * @method VillePo   setNomVille()   Sets the current record's "nom_ville" value
 * @method VillePo   setNomVille2()  Sets the current record's "nom_ville2" value
 * @method VillePo   setLatitude()   Sets the current record's "latitude" value
 * @method VillePo   setLongitude()  Sets the current record's "longitude" value
 * @method VillePo   setPaysMonde()  Sets the current record's "PaysMonde" value
 * 
 ...
 */
abstract class BaseVillePo extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('ville_po');
