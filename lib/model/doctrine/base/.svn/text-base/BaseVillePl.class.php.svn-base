...
Doctrine_Manager::getInstance()->bindComponent('VillePl', 'dbrmv3');
 ...
 * @method VillePl   setIdVille()    Sets the current record's "id_ville" value
 * @method VillePl   setIdPays()     Sets the current record's "id_pays" value
 * @method VillePl   setNomVille()   Sets the current record's "nom_ville" value
 * @method VillePl   setNomVille2()  Sets the current record's "nom_ville2" value
 * @method VillePl   setLatitude()   Sets the current record's "latitude" value
 * @method VillePl   setLongitude()  Sets the current record's "longitude" value
 * @method VillePl   setPaysMonde()  Sets the current record's "PaysMonde" value
 * 
 ...
 */
abstract class BaseVillePl extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('ville_pl');
