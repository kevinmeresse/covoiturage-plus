...
Doctrine_Manager::getInstance()->bindComponent('VilleGm', 'dbrmv3');
 ...
 * @method VilleGm   setIdVille()    Sets the current record's "id_ville" value
 * @method VilleGm   setIdPays()     Sets the current record's "id_pays" value
 * @method VilleGm   setNomVille()   Sets the current record's "nom_ville" value
 * @method VilleGm   setNomVille2()  Sets the current record's "nom_ville2" value
 * @method VilleGm   setLatitude()   Sets the current record's "latitude" value
 * @method VilleGm   setLongitude()  Sets the current record's "longitude" value
 * @method VilleGm   setPaysMonde()  Sets the current record's "PaysMonde" value
 * 
 ...
 */
abstract class BaseVilleGm extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('ville_gm');
