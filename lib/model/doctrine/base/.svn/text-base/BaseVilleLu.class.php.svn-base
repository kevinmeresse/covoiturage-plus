...
Doctrine_Manager::getInstance()->bindComponent('VilleLu', 'dbrmv3');
 ...
 * @method VilleLu   setIdVille()    Sets the current record's "id_ville" value
 * @method VilleLu   setIdPays()     Sets the current record's "id_pays" value
 * @method VilleLu   setNomVille()   Sets the current record's "nom_ville" value
 * @method VilleLu   setNomVille2()  Sets the current record's "nom_ville2" value
 * @method VilleLu   setLatitude()   Sets the current record's "latitude" value
 * @method VilleLu   setLongitude()  Sets the current record's "longitude" value
 * @method VilleLu   setPaysMonde()  Sets the current record's "PaysMonde" value
 * 
 ...
 */
abstract class BaseVilleLu extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('ville_lu');
