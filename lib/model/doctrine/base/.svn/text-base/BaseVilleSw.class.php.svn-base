...
Doctrine_Manager::getInstance()->bindComponent('VilleSw', 'dbrmv3');
 ...
 * @method VilleSw   setIdVille()    Sets the current record's "id_ville" value
 * @method VilleSw   setIdPays()     Sets the current record's "id_pays" value
 * @method VilleSw   setNomVille()   Sets the current record's "nom_ville" value
 * @method VilleSw   setNomVille2()  Sets the current record's "nom_ville2" value
 * @method VilleSw   setLatitude()   Sets the current record's "latitude" value
 * @method VilleSw   setLongitude()  Sets the current record's "longitude" value
 * @method VilleSw   setPaysMonde()  Sets the current record's "PaysMonde" value
 * 
 ...
 */
abstract class BaseVilleSw extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('ville_sw');
