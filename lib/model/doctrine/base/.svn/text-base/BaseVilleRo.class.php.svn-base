...
Doctrine_Manager::getInstance()->bindComponent('VilleRo', 'dbrmv3');
 ...
 * @method VilleRo   setIdVille()    Sets the current record's "id_ville" value
 * @method VilleRo   setIdPays()     Sets the current record's "id_pays" value
 * @method VilleRo   setNomVille()   Sets the current record's "nom_ville" value
 * @method VilleRo   setNomVille2()  Sets the current record's "nom_ville2" value
 * @method VilleRo   setLatitude()   Sets the current record's "latitude" value
 * @method VilleRo   setLongitude()  Sets the current record's "longitude" value
 * @method VilleRo   setPaysMonde()  Sets the current record's "PaysMonde" value
 * 
 ...
 */
abstract class BaseVilleRo extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('ville_ro');
