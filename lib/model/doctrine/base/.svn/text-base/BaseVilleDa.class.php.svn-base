...
Doctrine_Manager::getInstance()->bindComponent('VilleDa', 'dbrmv3');
 ...
 * @method VilleDa   setIdVille()    Sets the current record's "id_ville" value
 * @method VilleDa   setIdPays()     Sets the current record's "id_pays" value
 * @method VilleDa   setNomVille()   Sets the current record's "nom_ville" value
 * @method VilleDa   setNomVille2()  Sets the current record's "nom_ville2" value
 * @method VilleDa   setLatitude()   Sets the current record's "latitude" value
 * @method VilleDa   setLongitude()  Sets the current record's "longitude" value
 * @method VilleDa   setPaysMonde()  Sets the current record's "PaysMonde" value
 * 
 ...
 */
abstract class BaseVilleDa extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('ville_da');
