...
Doctrine_Manager::getInstance()->bindComponent('VilleEn', 'dbrmv3');
 ...
 * @method VilleEn   setIdVille()    Sets the current record's "id_ville" value
 * @method VilleEn   setIdPays()     Sets the current record's "id_pays" value
 * @method VilleEn   setNomVille()   Sets the current record's "nom_ville" value
 * @method VilleEn   setNomVille2()  Sets the current record's "nom_ville2" value
 * @method VilleEn   setLatitude()   Sets the current record's "latitude" value
 * @method VilleEn   setLongitude()  Sets the current record's "longitude" value
 * @method VilleEn   setPaysMonde()  Sets the current record's "PaysMonde" value
 * 
 ...
 */
abstract class BaseVilleEn extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('ville_en');
