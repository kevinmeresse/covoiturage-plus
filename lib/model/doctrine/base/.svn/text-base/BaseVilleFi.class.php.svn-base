...
Doctrine_Manager::getInstance()->bindComponent('VilleFi', 'dbrmv3');
 ...
 * @method VilleFi   setIdVille()    Sets the current record's "id_ville" value
 * @method VilleFi   setIdPays()     Sets the current record's "id_pays" value
 * @method VilleFi   setNomVille()   Sets the current record's "nom_ville" value
 * @method VilleFi   setNomVille2()  Sets the current record's "nom_ville2" value
 * @method VilleFi   setLatitude()   Sets the current record's "latitude" value
 * @method VilleFi   setLongitude()  Sets the current record's "longitude" value
 * @method VilleFi   setPaysMonde()  Sets the current record's "PaysMonde" value
 * 
 ...
 */
abstract class BaseVilleFi extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('ville_fi');
