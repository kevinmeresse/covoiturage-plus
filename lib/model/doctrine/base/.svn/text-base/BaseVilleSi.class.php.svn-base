...
Doctrine_Manager::getInstance()->bindComponent('VilleSi', 'dbrmv3');
 ...
 * @method VilleSi   setIdVille()    Sets the current record's "id_ville" value
 * @method VilleSi   setIdPays()     Sets the current record's "id_pays" value
 * @method VilleSi   setNomVille()   Sets the current record's "nom_ville" value
 * @method VilleSi   setNomVille2()  Sets the current record's "nom_ville2" value
 * @method VilleSi   setLatitude()   Sets the current record's "latitude" value
 * @method VilleSi   setLongitude()  Sets the current record's "longitude" value
 * @method VilleSi   setPaysMonde()  Sets the current record's "PaysMonde" value
 * 
 ...
 */
abstract class BaseVilleSi extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('ville_si');
