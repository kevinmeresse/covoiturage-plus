...
Doctrine_Manager::getInstance()->bindComponent('VilleAu', 'dbrmv3');
 ...
 * @method VilleAu   setIdVille()    Sets the current record's "id_ville" value
 * @method VilleAu   setIdPays()     Sets the current record's "id_pays" value
 * @method VilleAu   setNomVille()   Sets the current record's "nom_ville" value
 * @method VilleAu   setNomVille2()  Sets the current record's "nom_ville2" value
 * @method VilleAu   setLatitude()   Sets the current record's "latitude" value
 * @method VilleAu   setLongitude()  Sets the current record's "longitude" value
 * @method VilleAu   setPaysMonde()  Sets the current record's "PaysMonde" value
 * 
 ...
 */
abstract class BaseVilleAu extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('ville_au');
