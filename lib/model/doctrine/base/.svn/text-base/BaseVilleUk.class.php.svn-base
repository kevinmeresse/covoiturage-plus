...
Doctrine_Manager::getInstance()->bindComponent('VilleUk', 'dbrmv3');
 ...
 * @method VilleUk   setIdVille()    Sets the current record's "id_ville" value
 * @method VilleUk   setIdPays()     Sets the current record's "id_pays" value
 * @method VilleUk   setNomVille()   Sets the current record's "nom_ville" value
 * @method VilleUk   setNomVille2()  Sets the current record's "nom_ville2" value
 * @method VilleUk   setLatitude()   Sets the current record's "latitude" value
 * @method VilleUk   setLongitude()  Sets the current record's "longitude" value
 * @method VilleUk   setPaysMonde()  Sets the current record's "PaysMonde" value
 * 
 ...
 */
abstract class BaseVilleUk extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('ville_uk');
