...
Doctrine_Manager::getInstance()->bindComponent('VilleGr', 'dbrmv3');
 ...
 * @method VilleGr   setIdVille()    Sets the current record's "id_ville" value
 * @method VilleGr   setIdPays()     Sets the current record's "id_pays" value
 * @method VilleGr   setNomVille()   Sets the current record's "nom_ville" value
 * @method VilleGr   setNomVille2()  Sets the current record's "nom_ville2" value
 * @method VilleGr   setLatitude()   Sets the current record's "latitude" value
 * @method VilleGr   setLongitude()  Sets the current record's "longitude" value
 * @method VilleGr   setPaysMonde()  Sets the current record's "PaysMonde" value
 * 
 ...
 */
abstract class BaseVilleGr extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('ville_gr');
