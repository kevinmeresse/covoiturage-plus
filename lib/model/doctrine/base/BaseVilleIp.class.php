...
Doctrine_Manager::getInstance()->bindComponent('VilleIp', 'dbrmv3');
 ...
 * @method VilleIp   setIdVille()    Sets the current record's "id_ville" value
 * @method VilleIp   setIdPays()     Sets the current record's "id_pays" value
 * @method VilleIp   setNomVille()   Sets the current record's "nom_ville" value
 * @method VilleIp   setNomVille2()  Sets the current record's "nom_ville2" value
 * @method VilleIp   setLatitude()   Sets the current record's "latitude" value
 * @method VilleIp   setLongitude()  Sets the current record's "longitude" value
 * @method VilleIp   setPaysMonde()  Sets the current record's "PaysMonde" value
 * 
 ...
 */
abstract class BaseVilleIp extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('ville_ip');
