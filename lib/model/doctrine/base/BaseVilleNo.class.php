...
Doctrine_Manager::getInstance()->bindComponent('VilleNo', 'dbrmv3');
 ...
 * @method VilleNo   setIdVille()    Sets the current record's "id_ville" value
 * @method VilleNo   setIdPays()     Sets the current record's "id_pays" value
 * @method VilleNo   setNomVille()   Sets the current record's "nom_ville" value
 * @method VilleNo   setNomVille2()  Sets the current record's "nom_ville2" value
 * @method VilleNo   setLatitude()   Sets the current record's "latitude" value
 * @method VilleNo   setLongitude()  Sets the current record's "longitude" value
 * @method VilleNo   setPaysMonde()  Sets the current record's "PaysMonde" value
 * 
 ...
 */
abstract class BaseVilleNo extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('ville_no');
