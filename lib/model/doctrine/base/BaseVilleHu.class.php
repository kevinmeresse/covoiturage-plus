...
Doctrine_Manager::getInstance()->bindComponent('VilleHu', 'dbrmv3');
 ...
 * @method VilleHu   setIdVille()    Sets the current record's "id_ville" value
 * @method VilleHu   setIdPays()     Sets the current record's "id_pays" value
 * @method VilleHu   setNomVille()   Sets the current record's "nom_ville" value
 * @method VilleHu   setNomVille2()  Sets the current record's "nom_ville2" value
 * @method VilleHu   setLatitude()   Sets the current record's "latitude" value
 * @method VilleHu   setLongitude()  Sets the current record's "longitude" value
 * @method VilleHu   setPaysMonde()  Sets the current record's "PaysMonde" value
 * 
 ...
 */
abstract class BaseVilleHu extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('ville_hu');
