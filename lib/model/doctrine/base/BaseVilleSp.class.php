...
Doctrine_Manager::getInstance()->bindComponent('VilleSp', 'dbrmv3');
 ...
 * @method VilleSp   setIdVille()    Sets the current record's "id_ville" value
 * @method VilleSp   setIdPays()     Sets the current record's "id_pays" value
 * @method VilleSp   setNomVille()   Sets the current record's "nom_ville" value
 * @method VilleSp   setNomVille2()  Sets the current record's "nom_ville2" value
 * @method VilleSp   setLatitude()   Sets the current record's "latitude" value
 * @method VilleSp   setLongitude()  Sets the current record's "longitude" value
 * @method VilleSp   setPaysMonde()  Sets the current record's "PaysMonde" value
 * 
 ...
 */
abstract class BaseVilleSp extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('ville_sp');
