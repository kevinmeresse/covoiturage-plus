...
Doctrine_Manager::getInstance()->bindComponent('VilleFs', 'dbrmv3');
 ...
 * @method VilleFs   setIdVille()    Sets the current record's "id_ville" value
 * @method VilleFs   setIdPays()     Sets the current record's "id_pays" value
 * @method VilleFs   setNomVille()   Sets the current record's "nom_ville" value
 * @method VilleFs   setNomVille2()  Sets the current record's "nom_ville2" value
 * @method VilleFs   setLatitude()   Sets the current record's "latitude" value
 * @method VilleFs   setLongitude()  Sets the current record's "longitude" value
 * @method VilleFs   setPaysMonde()  Sets the current record's "PaysMonde" value
 * 
 ...
 */
abstract class BaseVilleFs extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('ville_fs');
