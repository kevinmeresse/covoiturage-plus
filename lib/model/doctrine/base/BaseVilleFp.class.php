...
Doctrine_Manager::getInstance()->bindComponent('VilleFp', 'dbrmv3');
 ...
 * @method VilleFp   setIdVille()    Sets the current record's "id_ville" value
 * @method VilleFp   setIdPays()     Sets the current record's "id_pays" value
 * @method VilleFp   setNomVille()   Sets the current record's "nom_ville" value
 * @method VilleFp   setNomVille2()  Sets the current record's "nom_ville2" value
 * @method VilleFp   setLatitude()   Sets the current record's "latitude" value
 * @method VilleFp   setLongitude()  Sets the current record's "longitude" value
 * @method VilleFp   setPaysMonde()  Sets the current record's "PaysMonde" value
 * 
 ...
 */
abstract class BaseVilleFp extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('ville_fp');
