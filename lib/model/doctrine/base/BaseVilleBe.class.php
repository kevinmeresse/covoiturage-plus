...
Doctrine_Manager::getInstance()->bindComponent('VilleBe', 'dbrmv3');
 ...
 * @method VilleBe   setIdVille()    Sets the current record's "id_ville" value
 * @method VilleBe   setIdPays()     Sets the current record's "id_pays" value
 * @method VilleBe   setNomVille()   Sets the current record's "nom_ville" value
 * @method VilleBe   setNomVille2()  Sets the current record's "nom_ville2" value
 * @method VilleBe   setLatitude()   Sets the current record's "latitude" value
 * @method VilleBe   setLongitude()  Sets the current record's "longitude" value
 * @method VilleBe   setPaysMonde()  Sets the current record's "PaysMonde" value
 * 
 ...
 */
abstract class BaseVilleBe extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('ville_be');
