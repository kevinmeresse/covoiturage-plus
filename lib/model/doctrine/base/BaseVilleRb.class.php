...
Doctrine_Manager::getInstance()->bindComponent('VilleRb', 'dbrmv3');
 ...
 * @method VilleRb   setIdVille()    Sets the current record's "id_ville" value
 * @method VilleRb   setIdPays()     Sets the current record's "id_pays" value
 * @method VilleRb   setNomVille()   Sets the current record's "nom_ville" value
 * @method VilleRb   setNomVille2()  Sets the current record's "nom_ville2" value
 * @method VilleRb   setLatitude()   Sets the current record's "latitude" value
 * @method VilleRb   setLongitude()  Sets the current record's "longitude" value
 * @method VilleRb   setPaysMonde()  Sets the current record's "PaysMonde" value
 * 
 ...
 */
abstract class BaseVilleRb extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('ville_rb');
