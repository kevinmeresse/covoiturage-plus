...
Doctrine_Manager::getInstance()->bindComponent('VilleAs', 'dbrmv3');
 ...
 * @method VilleAs   setIdVille()    Sets the current record's "id_ville" value
 * @method VilleAs   setIdPays()     Sets the current record's "id_pays" value
 * @method VilleAs   setNomVille()   Sets the current record's "nom_ville" value
 * @method VilleAs   setNomVille2()  Sets the current record's "nom_ville2" value
 * @method VilleAs   setLatitude()   Sets the current record's "latitude" value
 * @method VilleAs   setLongitude()  Sets the current record's "longitude" value
 * @method VilleAs   setPaysMonde()  Sets the current record's "PaysMonde" value
 * 
 ...
 */
abstract class BaseVilleAs extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('ville_as');
