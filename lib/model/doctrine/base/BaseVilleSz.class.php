...
Doctrine_Manager::getInstance()->bindComponent('VilleSz', 'dbrmv3');
 ...
 * @method VilleSz   setIdVille()    Sets the current record's "id_ville" value
 * @method VilleSz   setIdPays()     Sets the current record's "id_pays" value
 * @method VilleSz   setNomVille()   Sets the current record's "nom_ville" value
 * @method VilleSz   setNomVille2()  Sets the current record's "nom_ville2" value
 * @method VilleSz   setLatitude()   Sets the current record's "latitude" value
 * @method VilleSz   setLongitude()  Sets the current record's "longitude" value
 * @method VilleSz   setPaysMonde()  Sets the current record's "PaysMonde" value
 * 
 ...
 */
abstract class BaseVilleSz extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('ville_sz');
