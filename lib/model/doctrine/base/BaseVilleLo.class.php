...
Doctrine_Manager::getInstance()->bindComponent('VilleLo', 'dbrmv3');
 ...
 * @method VilleLo   setIdVille()    Sets the current record's "id_ville" value
 * @method VilleLo   setIdPays()     Sets the current record's "id_pays" value
 * @method VilleLo   setNomVille()   Sets the current record's "nom_ville" value
 * @method VilleLo   setNomVille2()  Sets the current record's "nom_ville2" value
 * @method VilleLo   setLatitude()   Sets the current record's "latitude" value
 * @method VilleLo   setLongitude()  Sets the current record's "longitude" value
 * @method VilleLo   setPaysMonde()  Sets the current record's "PaysMonde" value
 * 
 ...
 */
abstract class BaseVilleLo extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('ville_lo');
