 ...
 */
abstract class BaseLieuFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'id_pour_partenaire' => new sfWidgetFormFilterInput(),
      ...
      'date_evenement'     => new sfWidgetFormFilterDate(array('from_date' => new sfWidgetFormDate(), 'to_date' => new sfWidgetFormDate(), 'with_empty' => false)),
    ...
    $this->widgetSchema->setNameFormat('lieu_filters[%s]');
