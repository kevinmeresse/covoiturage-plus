...
/**
 * ZoneIndustrielle filter form base class.
 *
 ...
 */
abstract class BaseZoneIndustrielleFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'nom_zone_industrielle' => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'nom_zone_industrielle' => new sfValidatorPass(array('required' => false)),
    ...
    $this->widgetSchema->setNameFormat('zone_industrielle_filters[%s]');
  ...
  {
    return array(
      'id_zone_industrielle'  => 'Number',
      'cle'                   => 'Text',
      'etat'                  => 'Number',
      'date_creation'         => 'Date',
      'nom_zone_industrielle' => 'Text',
      'description'           => 'Text',
      'x'                     => 'Number',
      'y'                     => 'Number',
