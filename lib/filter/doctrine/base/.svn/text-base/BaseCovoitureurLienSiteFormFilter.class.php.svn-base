...
/**
 * CovoitureurLienSite filter form base class.
 *
 ...
 */
abstract class BaseCovoitureurLienSiteFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('covoitureur_lien_site_filters[%s]');
  ...
  {
    return array(
      'id_covoitureur_lien_site' => 'Number',
      'nom'                      => 'Text',
      'date_creation'            => 'Date',
