...
/**
 * VehiculeMarque filter form base class.
 *
 ...
 */
abstract class BaseVehiculeMarqueFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'nom_marque'    => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'nom_marque'    => new sfValidatorPass(array('required' => false)),
      'description'   => new sfValidatorPass(array('required' => false)),
    ));

    $this->widgetSchema->setNameFormat('vehicule_marque_filters[%s]');
