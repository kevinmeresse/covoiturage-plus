        ...
        <table width="600" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" style="font-family:Arial, Helvetica, sans-serif;font-size:11px">
            ...
            <tr>
                ...
                <td>
                    <p>Bonjour,<br/>
                        <br/>
                        Vous venez d'accepter la demande de covoiturage ci-dessous  :</p>
                    <p>- D&eacute;part : <?php echo $params["depart"] ?><br />
                        ...
                        - Nombre de places demand&eacute;es : <?php echo $params["places"] ?><br />
                    ...
                    <p>Si vous souhaitez annuler ce covoiturage sur ce trajet, cliquez sur  '<a href="http://{url_annule}">annuler cette demande</a>'.</p>
