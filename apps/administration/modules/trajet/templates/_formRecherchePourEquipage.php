...
<div class="form-tri">
  <?php echo jq_form_remote_tag(array(
    'update'   => 'item_list',
    'url'      => 'trajet/listeTrajetPourEquipage?id_equipage='.$id_equipage,
    )) ?>
                    ...
                    <div class="trajet_form_part2_inclu">
                        <label>Entreprise</label>
                            ...
                            <?php else: ?>    
                                <?php
                                echo jq_input_auto_complete_tag(
                                        'trajet[etablissement]', $tab_ville_autoc['etablissement'], url_for1('cp_etablissement/autocompleteCovoit', TRUE), array('autocomplete' => 'on', 'size' => '50'), array('use_style' => true))
                                ?>
                            <?php endif; ?> 
