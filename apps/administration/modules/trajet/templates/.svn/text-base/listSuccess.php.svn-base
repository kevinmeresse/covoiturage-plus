...
<?php include_component('trajet', 'formRecherche', array('tab_ville_autoc' => $tab_ville_autoc, 'filtre' => $filtre)) ?>

<?php include_partial('trajet/list', array('trajets' => $pager->getResults())) ?>
