        ...
        <table width="600" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" style="font-family:Arial, Helvetica, sans-serif;font-size:11px">
            ...
            <tr>
                ...
                <td>
                    <p>Bonjour,<br/>
                        <br/>
                        La demande de covoiturage ci-dessous a &eacute;t&eacute; accept&eacute;e :</p>
                    ...
                    <p>Si vous ne souhaitez plus covoiturer sur ce trajet, cliquez sur  '<a href="http://<?php echo $params["urlApplication"] ?>/<?php echo $params["urlAnnule"] ?>">annuler cette demande</a>'.</p>
