        ...
        <table width="600" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" style="font-family:Arial, Helvetica, sans-serif;font-size:11px">
            ...
            <tr>
                ...
                <td>
                    <p>Bonjour,<br/>
                        <br/>
                        Nous vous remercions de votre intérêt pour notre site de covoiturage <a href="http://<?php echo $params["urlApplication"] ?>"><?php echo $params["urlApplication"] ?></a>.</p>
                    <p>Vous pouvez cr&eacute;er un compte, d&eacute;poser des trajets de covoiturage, rentrer en relation avec d'autres covoitureurs.<br/>
                        <br/>
                        A bientôt sur <a href="http://<?php echo $params["urlApplication"] ?>"><?php echo $params["urlApplication"] ?></a><br/>
                        <br/>
                    </p></td>
                <td width="80">&nbsp;</td> 
            </tr>
