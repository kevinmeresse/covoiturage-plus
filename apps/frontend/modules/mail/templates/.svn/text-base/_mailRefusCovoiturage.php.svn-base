        ...
        <table width="600" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" style="font-family:Arial, Helvetica, sans-serif;font-size:11px">
            ...
            <tr>
                ...
                <td>
                    <p>Bonjour,<br/>
                        <br/> 
                        La demande de covoiturage ci-dessous a &eacute;t&eacute; refus&eacute;e :</p>
                    <p>- D&eacute;part : <?php echo $params["depart"] ?><br />
                        ...
                        - D&eacute;positaire :<?php echo $params["depositaire"] ?><br />
                        - Coordonnées du d&eacute;positaire : <?php echo $params["coordonneeDepositaire"] ?></p>
                    <p>Vous pouvez effectuer une nouvelle r&eacute;servation en vous connectant &agrave; votre espace personnel sur <a href="http://<?php echo $params["urlApplication"] ?>"><?php echo $params["urlApplication"] ?></a>.</p>
