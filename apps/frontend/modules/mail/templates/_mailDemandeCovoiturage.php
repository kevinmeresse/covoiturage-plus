    ...
    <body bgcolor="#FFFFFF" style="font-family:Arial, Helvetica, sans-serif;font-size:11px">
        ...
        <table width="600" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" style="font-family:Arial, Helvetica, sans-serif;font-size:11px">
            ...
            <tr>
                <td width="80">&nbsp;</td>
                <td>
                    <p>Bonjour<?php echo $params["depositaire"] ?>,<br/>
                        <br/>
                        Vous avez une demande de covoiturage :</p>
                    ...
                    <p>&nbsp;</p>
                    <p>Acceptez-vous cette demande de covoiturage ? <a href="http://<?php echo $params["urlApplication"] ?>/<?php echo $params["urlValide1"] ?>">OUI</a> - <a href="http://<?php echo $params["urlApplication"] ?>/<?php echo $params["urlValide0"] ?>">NON</a></p>
