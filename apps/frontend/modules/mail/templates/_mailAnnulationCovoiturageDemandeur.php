        ...
        <table width="600" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" style="font-family:Arial, Helvetica, sans-serif;font-size:11px">
            ...
            <tr>
                ...
                <td>
                    <p>Bonjour,<br/>
                        <br/> 
                        Le trajet de covoiturage suivant auquel vous &eacute;tiez inscrit est annul&eacute; :</p>
                    <p>- D&eacute;part : <?php echo $params["depart"] ?><br />
                        ...
                        - Coordonn&eacute;es du d&eacute;positaire : <?php echo $params["coordonneeDepositaire"] ?></p>
                    <p>Nous vous invitons &agrave; consulter les offres de covoiturage disponibles  sur <a href="http://<?php echo $params["urlApplication"] ?>"><?php echo $params["urlApplication"] ?></a>.</p>
